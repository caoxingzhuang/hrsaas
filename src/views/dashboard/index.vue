      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">{{ userInfo.username }} | giao - {{ userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p>
                        <span class="col">朱继柳</span> 发布了 第1期“大讲堂”互动讨论获奖名单公布
                      </p>
                ...
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p>
                        <span class="col">朱继柳</span> 发布了 第2期“大讲堂”互动讨论获奖名单公布
                      </p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                ...
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p>
                        <span class="col">朱继柳</span> 发布了 第3期“讲堂”互动讨论获奖名单公布
                      </p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
